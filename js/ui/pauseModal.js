...
export function drawSettingsModal(ctx, { mouse }) {
  ...
  drawText(ctx, '<', leftRect.x + arrowW / 2, rowY, {
    size: 12, color: leftHover ? COLORS.amberBright : COLORS.cream,
    font: UI_FONT, baseline: 'middle', align: 'center',
  });
